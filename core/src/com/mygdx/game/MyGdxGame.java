...
public class MyGdxGame extends ApplicationAdapter {
	...
	public void create () {
		...
		manAssetss.put(Actions.STAND, new MyAtlasAnim("atlas/unnamed.atlas", "mario_stand", 17, false, "assets_single_on_dirty_stone_step_flip_flop_007_30443.mp3"));
		manAssetss.put(Actions.RUN, new MyAtlasAnim("atlas/unnamed.atlas", "mario_run", 17, true, "assets_single_on_dirty_stone_step_flip_flop_007_30443.mp3"));
		manAssetss.put(Actions.JUMP, new MyAtlasAnim("atlas/unnamed.atlas", "mario_jump", 17, true, "assets_single_on_dirty_stone_step_flip_flop_007_30443.mp3"));
